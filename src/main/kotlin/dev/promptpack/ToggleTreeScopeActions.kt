...
abstract class BaseTreeScopeToggleAction(
  ...
  private fun notifyMode(project: Project?, scope: TreeScope) {
...
class TreeScopeProjectToggleAction : BaseTreeScopeToggleAction(
  TreeScope.PROJECT, PromptPackBundle.message("menu.toggle.project")
)

class TreeScopeSelectionToggleAction : BaseTreeScopeToggleAction(
  TreeScope.SELECTION, PromptPackBundle.message("menu.toggle.selection")
)

class TreeScopeNoneToggleAction : BaseTreeScopeToggleAction(
  TreeScope.NONE, PromptPackBundle.message("menu.toggle.none")
)
